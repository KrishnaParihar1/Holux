...
function scrollHeader() {
  ...
  if (window.scrollY >= 50) {
    header.classList.add("scroll-header"); // Add class when scrolled down
  } else {
    header.classList.remove("scroll-header"); // Remove class when scrolled up
  }
}
...
// Retrieve previously selected theme and icon
